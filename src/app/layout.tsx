...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        <div className="h-dvh w-dvh flex justify-center bg-[url('/flowers.png')] bg-no-repeat bg-[length:250px] md:bg-[length:350px] lg:bg-contain pt-8 px-8 sm:pt-48 bg-left-bottom">
          {children}
        </div>
      </body>
    </html>
